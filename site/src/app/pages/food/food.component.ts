...
export class FoodComponent{
  ...
  constructor(
    ...
    // console.log("Holaaa" + data?.mostrarBotonModal)
    // if(data?.mostrarBotonModal != null){
    //   console.log("Boton:" + this.mostrarBotonModal);
    //   this.mostrarBotonModal = data.mostrarBotonModal;
    // }
  }
